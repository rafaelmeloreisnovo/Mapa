...
A busca federada encontrou numerosos falsos positivos de siglas em QEMU/dependências e referências científicas/jurídicas legítimas. Uma rota anteriormente catalogada foi revalidada como não acessível e já foi retirada do backlog ativo na reconciliação da `main`.
