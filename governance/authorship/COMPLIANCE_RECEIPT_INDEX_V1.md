# Compliance Receipt Index V1

This index binds governance artifacts for authorship/licensing review.

- policy: `governance/authorship/RAFAELIA_AUTHORSHIP_PROVENANCE_CLEANROOM_V1.md`
- registry: `governance/authorship/AUTHORSHIP_PROVENANCE_REGISTRY.v1.json`
- receipt template: `governance/authorship/AUTHORSHIP_RECEIPT_TEMPLATE.v1.json`
- release gate: `governance/authorship/LEGAL_RELEASE_GATE_V1.md`
- naming policy: `governance/authorship/AUTHORIAL_SUCCESSOR_NAMING_POLICY_V1.md`
