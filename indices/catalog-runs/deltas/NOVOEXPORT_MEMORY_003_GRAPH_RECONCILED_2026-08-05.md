...
- cobertura longitudinal promovida para `4/51`.
...
1. Rotear relações privadas de recorrência ao ledger do grafo.
2. Enfileirar `conversations-004.json` somente após fechamento dos receipts.
3. Manter `claim_allowed=false`, treinamento desabilitado e merge automático bloqueado.
