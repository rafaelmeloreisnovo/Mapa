    ...
    if legacy_schema in LEGACY_SCHEMAS:
        ...
        if claim_allowed is not False:
            print(json.dumps({
                ...
                "errors": ["legacy records require claim_allowed=false"],
        ...
        print(json.dumps({
            ...
            "claim_allowed": False,
            "status": record.get("state", "TOKEN_VAZIO"),
            "closure_result": "TOKEN_VAZIO_REVALIDATION_REQUIRED",
            "next_probe": record.get("next_probe"),
            "anti_promotion_invariant": "LEGACY_ACCEPTED_NE_CANONICAL_VALIDATED_NE_CLOSED_BY_EVIDENCE",
        }, indent=2, sort_keys=True, ensure_ascii=False))
        return 0
