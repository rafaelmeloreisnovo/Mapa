...
Execution: python3 validate_cross_repo_dedup.py --lineage-check
...
def main():
    ...
    if not args.lineage_check:
        print("Usage: python3 validate_cross_repo_dedup.py --lineage-check")
        return 0
