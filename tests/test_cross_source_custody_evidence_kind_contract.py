#!/usr/bin/env python3
"""Regression contract for custody evidence kinds and historical-chain validation."""
...
class CustodyEvidenceKindContractTests(unittest.TestCase):
    ...
    def test_cross_source_gate_does_not_compare_historical_objects_to_head(self) -> None:
        gate = GATE_PATH.read_text(encoding="utf-8")
        self.assertIn("validator.validate_ledger(ledger)", gate)
        self.assertNotIn("validator.validate_ledger(ledger, root)", gate)
